// var { ar_shadow_noxhrurls, ar_shadow_yourdomain } = require("./config.js");
var ar_shadow_noxhrurls = ''
var ar_shadow_yourdomain = ''
// var JSEncrypt = require("./jsencrypt.js");
const JSEncrypt = require('jsencrypt');
var AR_SHADOW_CRC32 = require("./crc32c.js");
...
(function(u) {
  ...
  for (var s = AR_SHADOW_CryptoJS, q = s.lib, w = q.WordArray, v = q.Hasher, q = s.algo, b = [], x = 0; 64 > x; x++) b[x] = 4294967296 * u.abs(u.sin(x + 1)) | 0;
  q = q.MD5 = v.extend({
    _doReset: function() {
...
(function() {
  var u = AR_SHADOW_CryptoJS, l = u.lib, d = l.Base, n = l.WordArray, l = u.algo, p = l.EvpKDF = d.extend({
...
AR_SHADOW_CryptoJS.lib.Cipher || function(u) {
  var l = AR_SHADOW_CryptoJS, d = l.lib, n = d.Base, p = d.WordArray, s = d.BufferedBlockAlgorithm, q = l.enc.Base64,
...
(function() {
  ...
  var d = AR_SHADOW_CryptoJS, n = d.lib, p = n.WordArray, n = n.BlockCipher, s = d.algo,
...
var ar_shadow_initPub = "-----BEGIN PUBLIC KEY-----MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDq93W53gKS+FW81sr6+ZPJVrejdYtgKKBtJbciDugNJDzJKjSkQRxTxH51AeUOhY9ADVFo7blyQ1HvH+7RBLV6jswRgbG07E5SIjEd1iC0QkYxPe4xrn/9Xv81fzplp5m1igDr2xApnB3otUry8nopWEjHOhjvO0qKYNBEcIgN7QIDAQAB-----END PUBLIC KEY-----";
var AR_SHADOW_GetRandom = function() {
  for (var r = "", a = "abcdefghijkllmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", t = 0; t < 8; t++) r += a.charAt(parseInt(63 * Math.random(), 10));
  return r;
  ...
  var t = new JSEncrypt;
  if (t.setPublicKey(a), r) return AR_SHADOW_Base64Url(t.encrypt(r));
};

function ar_shadow_desbase(r, a, t) {
  var e, o, _, n, d, s, i;
  return e = AR_SHADOW_GetRandom(), o = AR_SHADOW_CryptoJS.enc.Utf8.parse(e), _ = AR_SHADOW_CryptoJS.DES.encrypt(r, o, {
    mode: AR_SHADOW_CryptoJS.mode.ECB,
    padding: AR_SHADOW_CryptoJS.pad.Pkcs7,
  }), d = (n = AR_SHADOW_Base64Url(_.toString())).length, i = (AR_SHADOW_CRC32.str(n) >>> 0).toString().padStart(16, "0"), s = AR_SHADOW_DoEncrypt(e + d + "|" + i + "|", a), 1 == t ? encodeURIComponent(s + n) : s + n;
}
...
function ar_shadow_addparametertourl(r, a, t, e, o) {
  var _ = !0;
  ar_shadow_yourdomain && (_ = !!ar_shadow_yourdomain.match(/^(https?:)?\/\/([a-z0-9]+(-[a-z0-9]+)*\.)+[a-z0-9]{1,}(:[0-9]*)?/gi) && r.indexOf(ar_shadow_yourdomain) > -1);
  var n = ar_shadow_isurlnotinarray(r, ar_shadow_noxhrurls.split(","));
  if (_ && n) {
    var d = "0000000000000000000" + (new Date).getTime() + "||||" + AR_SHADOW_CryptoJS.MD5(t).toString(AR_SHADOW_CryptoJS.enc.Hex) + "|" + e + "||-$-$-$0$-$-$-$-$1|-|-|-|0|-||-|";
    if (r += (r.split("?")[1] ? "&" : "?") + "arshadowurlqueryparamid=" + ar_shadow_desbase(d, o, 1), a && "object" == typeof a) {
      return {
        requrl: r, reqbody: Object.fromEntries(Object.entries(a).map((([r, a]) => {
          ar_shadow_desbase(r, o, 0);
          let t = a;
          return "string" == typeof a && (t = "shadowanruiform" + ar_shadow_desbase(a, o, 0)), [r, t];
        }))),
      };
    }
    return { requrl: r };
...
module.exports = {
  ar_shadow_addparametertourl: ar_shadow_addparametertourl,
  ar_shadow_initPub: ar_shadow_initPub,
